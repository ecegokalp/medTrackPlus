    ...
    if (shouldDetect) {
      ...
      try {
        ...
        if (inputImage != null) {
          ...
          // wasteful, (b) dilutes the score because post-swallow frames have
          // no pill on tongue. The 30s timer remains as a fallback for cases
          // where swallowConfirmed never arrives.
